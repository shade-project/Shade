...
const string strMessageMagic = "Shade Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Shade", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CoinDesk.com - Bitcoin Pioneer and First Bitcoin Recipient Hal Finney Passes Away 30/08/2014";
        CTransaction txNew;
        txNew.nTime = 1409354903;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1409354903;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2446475;


        //// debug print
        ///
        assert(block.hashMerkleRoot == uint256("0xe1de129436110f052dbff28eb402f839e5e551f3ed637fc500cafc51e2b62a0a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa7, 0xe5, 0x03, 0x22 };
