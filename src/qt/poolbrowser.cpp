...
//Bittrex API
const QString apiBittrexMarketSummary = "http://api.shadecoin.com/bittrex/market.php";
const QString apiBittrexTrades = "http://api.shadecoin.com/bittrex/trades.php";
const QString apiBittrexOrders = "http://api.shadecoin.com/bittrex/orders.php";

//Mintpal API
const QString apiMintpalMarketSummary = "http://api.shadecoin.com/mintpal/market.php";
const QString apiMintpalTrades = "http://api.shadecoin.com/mintpal/trades.php";
const QString apiMintpalOrdersSell = "http://api.shadecoin.com/mintpal/orders_sell.php";
const QString apiMintpalOrdersBuy = "http://api.shadecoin.com/mintpal/orders_buy.php";

//Poloniex API
const QString apiPoloniexMarketSummary = "http://api.shadecoin.com/poloniex/market.php";
const QString apiPoloniex24hVolume = "http://api.shadecoin.com/poloniex/chartdata.php";
const QString apiPoloniexTrades = "http://api.shadecoin.com/poloniex/trades.php";
const QString apiPoloniexOrders = "http://api.shadecoin.com/poloniex/orders.php";

//Cryptsy API
const QString apiCryptsyTrades = "http://api.shadecoin.com/cryptsy/trades.php";
const QString apiCryptsyOrders = "http://api.shadecoin.com/cryptsy/orders.php";
...
void PoolBrowser::on_btnConvertShade_clicked() {
    double ShadeQty = ui->txtConvertShadeQty->text().toDouble();
    double totalBtc = _bittrexMarketSummary->getLastCurrent(double()) * ShadeQty;
    double totalUsd = totalBtc * _dBtcPriceCurrent;

    ui->lblConvertShadeResults->setText("$" + QString::number(totalUsd, 'f', 2) +
    ...
    try {
        ...
        for (int i = 0; i < qslApiResponse.count(); i++) {
            ...
            if (read_string(qslApiResponse[i].toStdString(), jsonResponse)) {
                ...
                if (getPairValue(jsonObject, "MarketName").get_str() == "BTC-SHADE") {
                    try {
...
void PoolBrowser::poloniexMarketSummary(QNetworkReply* response) {
    try {
        ...
        QJsonObject scMarket = jsonObject["BTC_SHADE"].toObject();
...
void PoolBrowser::cryptsyTrades(QNetworkReply* response) {
    try {
        ...
        QStringList qslApiResponse = apiResponse.replace("{\"success\":1,\"return\":{\"markets\":{\"SHADE\":", "").replace(",\"recenttrades\":", "}").replace("]}}}}", "").replace("},{", "}{").split("[");
...
void PoolBrowser::cryptsyOrders(QNetworkReply* response) {
    try {
        ...
        apiResponse = apiResponse.replace("{\"success\":1,\"return\":{\"SHADE\":{\"marketid\":\"225\",\"label\":\"SHADE\\/BTC\",\"primaryname\":\"Shade\",\"primarycode\":\"SHADE\",\"secondaryname\":\"BitCoin\",\"secondarycode\":\"BTC\",\"sellorders\":[", "");
