...
SendCoinsDialog::SendCoinsDialog(QWidget *parent) :
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Shade address (e.g. S84rQg84NxRoEdH4erQsAqFckyf9pRHN6i)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text) {
    if (model) {
        ...
        if (text.isEmpty()) {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Shade address"));
        } else {
